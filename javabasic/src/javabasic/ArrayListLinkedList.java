...
public class ArrayListLinkedList {
	...
	public static void main(String[] args) {
		...
		System.out.println("ArrayList add : " + (alEndTime2-alStartTime2));
		System.out.println("ArrayList add : " + (llEndTime-llStartTime));
		System.out.println("ArrayList add : " + (llEndTime2-llStartTime2));
